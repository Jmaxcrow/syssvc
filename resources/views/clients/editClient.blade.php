...
<style>
	...
	<div class="container">
		{{!! Form::open(['route'=> ['clients.update', 'id' => $client->idClient], 'method' => 'PUT']) !!}
			{!! csrf_field() !!}
			<h2 class="col-md-12">Actualizacion de Cliente</h2>
			<div class="col-md-12">
				<div class="form-group col-md-2">
					<label for="celular">Telef. Celular</label>
					<input type="text" name="celular" class="form-control" value="{{$client->phone_number}}">
				</div>
				<div class="form-group col-md-2">
					<label for="casa">Telef. Casa</label>
					<input type="text" name="casa" class="form-control" value="{{$client->house_phone_number}}">
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group col-md-5">
					<label for="nombre">Nombre</label>
					<input type="text" name="nombre" maxlength="50" class="form-control" value="{{$client->name}}">
				</div>
				<div class="form-group col-md-7">
					<label for="apellido">Apellidos</label>
					<input type="text" name="apellido" maxlength="75" class="form-control" value="{{$client->lastname}}">
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group col-md-4">
					...
					<input type="date" name="fecha_nacimiento" class="form-control" value="{{ date_format($birthday,'Y-m-d')}}">
				</div>
				<div class="form-group col-md-3">
					...
					<div class="radio">
					 	<label>
					    		...
					    		@else
										<input type="radio" name="genero" id="" value="H">
									@endif
					    		Hombre
					 	 </label>
					</div>
					<div class="radio">
					 	<label>
					    		@if($client->sex == 'M')
					    			<input type="radio" name="genero" id="" value="M" checked>
					    		@else
				...
				<div class="form-group col-md-2">
					...
					<div class="radio">
					 	<label>
					 			@if($client->isClient == '1')
					    		<input type="radio" name="esCliente" id="" value="1" checked>
					    	@else
					    		<input type="radio" name="esCliente" id="" value="1">
					    	@endif
					    		Sí
					 	 </label>
					</div>
					<div class="radio">
					 	<label>
					    	@if($client->isClient == '0')
					    		<input type="radio" name="esCliente" id="" value="0" checked>
					    	@else
				...
				<div class="form-group col-md-2">
					...
					<div class="radio">
					 	<label>
					 				@if($client->hasWorks == '1')
					    			<input type="radio" name="trabaja" id="" value="1" checked>
					    		@else
					    			<input type="radio" name="trabaja" id="" value="1">
					    		@endif
					    		Sí
					 	 </label>
					</div>
					<div class="radio">
					 	<label>
					    		@if($client->hasWorks == '0')
					    			<input type="radio" name="trabaja" id="" value="0" checked>
					    		@else
			...
			<div class="col-md-6">
				<div class="form-group col-md-7">
					...
					<input type="text" name="direccion" class="form-control" value="{{$client->address}}">
				</div>
				<div class="form-group col-md-2">
				...
				<div class="form-group  col-md-3">
					...
					<input type="text" name="nro_apt" class="form-control" value="{{$client->number_apt}}">
				</div>
				<div class="form-group  col-md-4">
					<label for="ciudad">Ciudad</label>
					<input type="text" name="ciudad" class="form-control" value="{{$client->city}}">
				</div>
				<div class="form-group col-md-4">
					<label for="estado">Estado</label>
					<input type="text" name="estado" class="form-control" value="{{$client->state}}">
				</div>
				<div class="form-group col-md-4">
			...
			<div class="col-md-6">
				<div class="form-group col-md-4">
					...
					<input type="text" name="nroCuenta" class="form-control" value="{{$client->count_number}}">
				</div>
				<div class="form-group col-md-4">
					<label for="zone">Zona</label>
					<select name="zone" id="zona" class="form-control">
						@foreach(	$zones as $zona )
							@if($zona->idZone == $client->zone)
								<option value="{{ $zona->idZone }}" selected="true">{{ $zona->name }}</option>
								<?php continue; ?>
							@endif
				...
				<div class="form-group col-md-12">
					...
					<textarea name="comentarios" class="form-control" id="" rows="2">{{ $client->commentaries }}</textarea>
				</div>
			</div>
			<div class="col-md-9">
				<div class="form-group col-md-3">
					...
					<select name="origen_cliente" id="origen_cliente" class="form-control">
						@foreach(	$origins as $origen_cliente  )
							@if($origen_cliente->idOrigin == $client->origin)
								<option value="{{ $origen_cliente->idOrigin }}" selected="true">{{ $origen_cliente->name }}</option>
								@<?php continue; ?>
							@endif
				...
				<div class="form-group col-md-3">
					...
					<select name="sub_origen" id="sub_origen" class="form-control">
						@foreach(	$sub_origins as $sub_origin  )
							@if($sub_origin->idSubOrigin == $client->sub_origin)
								<option value="{{ $sub_origin->idSubOrigin }}" selected="true">{{ $sub_origin->name }}</option>
								<?php continue; ?>
							@endif
				...
				<div class="form-group col-md-3">
					...
					<input type="date" name="fecha_origen" class="form-control" value="{{ date_format($date_origin, 'Y-m-d') }}">
				</div>
				<div class="form-group col-md-3">
					<label for="hora_origen">Hora Origen</label>
					<input type="text" name="hora_origen" class="form-control" value="{{ $client->time_origin }}" >
				</div>
			</div>
			<div class="col-md-3">
